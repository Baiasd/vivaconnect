...
const loadAreaList = async () => {
  areaList.value = (await axios.get('/api/address/area/findAreaList')).data
  console.log("区域列表：", buildingList.value)
}

const loadBuildingList = async () => {
  buildingList.value = await (await axios.get('/api/address/building/findBuildingListByAid', {
    params: {aid: area.aid}
  })).data
...
const onSubmit = () => {
  ...
  axios.post(`/api/address/room/add`, room)
}
</script>
  ...
  <el-row class="row-bg" justify="space-around" align="middle">
    ...
    <el-col :span="4">
      <div class="grid-content ep-bg-purple-light">
        ...
        <el-link href="/#/user/address/room" type="info">住房管理></el-link>
        <el-link disabled>新增住房</el-link>
      </div>
    </el-col>
  </el-row>
